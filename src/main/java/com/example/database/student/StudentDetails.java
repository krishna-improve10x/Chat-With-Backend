...
public class StudentDetails {
    ...
    @GetMapping(value = "studentsList/major", produces = MediaType.APPLICATION_JSON_VALUE)
    public List<Student> getStudentDetails(@RequestParam("major") String major){
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT * FROM student where major = "+major+" order by graduation_year desc");
